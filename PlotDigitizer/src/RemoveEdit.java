/**
 * RemoveEdit -- Records remove edits to a List for undo/redo functionality.
 *
...
/**
 * Class used to record the changes made to a List object as elements are removed. This
...
public class RemoveEdit extends AbstractUndoableEdit {
    ...
    public RemoveEdit(List list, Object element, int index, String presName) {
        this.list = list;
